...
def test_unseen_items_all_extract(tmp_db: duckdb.DuckDBPyConnection) -> None:
...
def test_unchanged_items_skipped(tmp_db: duckdb.DuckDBPyConnection) -> None:
...
def test_changed_content_re_extracts(tmp_db: duckdb.DuckDBPyConnection) -> None:
    record_processed_item(tmp_db, "arxiv", "https://x/1", "h1")
...
def test_touch_updates_last_seen_for_skipped(tmp_db: duckdb.DuckDBPyConnection) -> None:
...
def test_intra_batch_duplicates_collapse(tmp_db: duckdb.DuckDBPyConnection) -> None:
