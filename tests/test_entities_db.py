...
def test_aliases_round_trip(tmp_db: MeshConnection) -> None:
...
def test_attributes_round_trip(tmp_db: MeshConnection) -> None:
...
def test_update_canonical_name(tmp_db: MeshConnection) -> None:
    e = _make_entity()
    create_entity(tmp_db, e)
...
def test_list_limit(tmp_db: MeshConnection) -> None:
    for i in range(10):
